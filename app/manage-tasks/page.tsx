        ...
        <Layout children={
            <div className="space-y-8">
                ...
                <div className="flex flex-col-reverse sm:flex-row items-end justify-between gap-4">
                    ...
                    />
                    <button className="px-4 py-2 bg-gray-900 hover:bg-gray-800 text-xs font-semibold text-white rounded-lg transition-colors cursor-pointer" onClick={() => router.push("/manage-tasks/add")}>Add Project</button>
                </div>
                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="border-t border-b border-gray-200 p-3 w-[30%] text-left font-medium text-gray-500">Project Name</th>
                                    <th className="border-t border-b border-gray-200 p-3 w-[20%] text-left font-medium text-gray-500">Creator</th>
                                    <th className="border-t border-b border-gray-200 p-3 w-[20%] text-center font-medium text-gray-500">Created At</th>
                                ...
                                {loading ? (
                                    ...
                                    projects.map((project) => (
                                        <tr key={project.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="p-3 text-gray-600">{project.owner_name || "N/A"}</td>
