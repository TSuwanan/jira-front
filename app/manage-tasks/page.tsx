        ...
        <Layout children={
            <div className="space-y-8">
                ...
                <div className="flex flex-col-reverse sm:flex-row items-end justify-between gap-4">
                    ...
                    />
                    <button className="px-4 py-2 bg-gray-900 hover:bg-gray-800 text-xs font-semibold text-white rounded-lg transition-colors cursor-pointer" onClick={() => router.push("/manage-users/add")}>Add Tasks</button>
                </div>
                    ...
                    <div className="">
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="border-t border-b border-gray-200 p-3 w-[15%] text-left font-medium text-gray-500">Task ID</th>
                                    <th className="border-t border-b border-gray-200 p-3 w-[30%] text-left font-medium text-gray-500">Task Name</th>
                                    <th className="border-t border-b border-gray-200 p-3 w-[30%] text-left font-medium text-gray-500">Type</th>
                                    <th className="border-t border-b border-gray-200 p-3 w-[30%] text-left font-medium text-gray-500">Responsible</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                ...
                                {[...Array(4)].map((_, i) => (
                                    <tr key={i} className="hover:bg-gray-50 transition-colors">
                                        <td className="p-3 text-gray-900 font-medium">TSK002{4 + i}</td>
